...
public class PropNameTagUI : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        Vector3 screenPoint = Camera.main.WorldToScreenPoint(TargetProp.PropObj.transform.TransformPoint(TargetProp.GetBoundsGround()) + new Vector3(0, 0, -50 * Camera.main.transform.position.y / 800));
